...
$total_peminjaman = 0; // Inisialisasi nilai default
...
$total_peminjam = 0; // Inisialisasi nilai default
if ($result_member_peminjam && $result_member_peminjam->num_rows > 0) {
...
$user_paling_banyak_meminjam = "Tidak ada data"; // Nilai default jika tidak ada data
$total_peminjaman_user = 0; // Nilai default jika tidak ada data
if ($result_user_paling_banyak_meminjam && $result_user_paling_banyak_meminjam->num_rows > 0) {
...
$buku_paling_banyak_dipinjam = "Tidak ada data"; // Nilai default jika tidak ada data
$total_peminjaman_buku = 0; // Nilai default jika tidak ada data
if ($result_buku_paling_banyak_dipinjam && $result_buku_paling_banyak_dipinjam->num_rows > 0) {
...
$buku_paling_banyak_disimpan = "Tidak ada data"; // Nilai default jika tidak ada data
$total_koleksi_buku = 0; // Nilai default jika tidak ada data
if ($result_buku_paling_banyak_disimpan && $result_buku_paling_banyak_disimpan->num_rows > 0) {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul>
                                <?php 
                                if ($result_kategori_buku && $result_kategori_buku->num_rows > 0) {
                                    while($row_kategori_buku = $result_kategori_buku->fetch_assoc()): 
                                ?>
